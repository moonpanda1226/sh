...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm"
		...
		<div class="container px-5">
			<a class="navbar-brand fw-bold" href="#page-top">이뚱월드에 오신걸 환영합니다</a>
	...
	<section>
		...
		<div class="m-5 p-5 border-top border-bottom border-success">
			<table class="mx-2 table table-hover">
				<thead>
					<tr>
		...
		<div class="container bg-info text-white">
			이 하늘색 맘에 안드네
			<div class="m-5 mb-0 bg-primary">이 파란색 맘에 안드네</div>
			<div class="mx-2 my-4 py-5 bg-secondary">흠.. 보라는 이쁘군</div>
			<div class="my-2 bg-secondary w-25">사실 셋 다 이뻐</div>
			<div class="my-2 bg-secondary w-50">이거 재밌어</div>
			<div class="my-2 bg-secondary w-75">왜 안놀러오냐</div>
